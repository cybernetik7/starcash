...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("STC");
    case mBTC: return QString("mSTC");
    case uBTC: return QString::fromUtf8("μSTC");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("StarCashs"));
    case mBTC: return QString(QObject::tr("Milli-StarCashs (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-StarCashs (1 / 1,000,000)"));
    default: return QString("???");
    }
}
